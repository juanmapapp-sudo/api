...
export async function registerUser(firstName, lastName, email, birthDate, phoneNumber, otp, passwordHash) {
  const sql = `
    INSERT INTO dbo."User" ("FirstName", "LastName", "Email", "BirthDate", "PhoneNumber", "CurrentOTP", "Password")
    VALUES ($1,$2,$3,$4,$5,$6,$7)
    RETURNING "UserId", "FirstName", "LastName", "Email", "BirthDate", "PhoneNumber", "CurrentOTP", "Active", "IsVerifiedUser";
  `;
  const params = [firstName, lastName, email, birthDate, phoneNumber, otp, passwordHash]; // Default OTP for now
